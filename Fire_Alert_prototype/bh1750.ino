...
BH1750 lightSensor2(0x23); // Sensor 2 with ADDR to VCC
  ...
  if (Normal_mode)
  {
    if (millis() - timeless > 5000)
    {
      ...
      if (Right_open)
      {
        ...
        if (1/*VALUE_PROVE(rl_temp, rl_hum*/) /*&& ((rl_temp <= mean_temp - 5) && (rl_hum <= mean_hum - 5))*///)
        {
